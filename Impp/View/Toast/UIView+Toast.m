...
static const CGFloat CSToastCornerRadius        = 0;//10.0;
static const CGFloat CSToastOpacity             = 1;//0.8;
static const CGFloat CSToastFontSize            = 13;//16.0;
static const CGFloat CSToastMaxTitleLines       = 0;
static const CGFloat CSToastMaxMessageLines     = 0;
static const NSTimeInterval CSToastFadeDuration = 0.2;

// shadow appearance
static const CGFloat CSToastShadowOpacity       = 0;//0.8;
static const CGFloat CSToastShadowRadius        = 0;//6.0;
...
- (void)makeImppToast:(NSString *)message navigationBarHeight:(CGFloat)navH
{
    ...
    messageLabel.textColor = [UIColor color5];
    messageLabel.font = [UIFont fontWithName:@"STHeitiTC-Medium" size:13];
    UIView *toast = [[UIView alloc]initWithFrame:messageLabel.frame];
    toast.backgroundColor = [UIColor color11];
    [toast addSubview:messageLabel];
    [toast setAutoresizingMask:(UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleBottomMargin)];
    [self showToast:toast duration:CSToastDefaultDuration position:[NSValue valueWithCGPoint:CGPointMake(frame.size.width/2, frame.size.height - 44/2 - navH)]];
}
